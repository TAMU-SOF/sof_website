  ...
  return (
    <main className="min-h-screen bg-white text-black pt-16 overflow-hidden">
      ...
      <div className="fixed inset-0 overflow-hidden pointer-events-none">
        <motion.div
          className="absolute top-20 right-10 w-72 h-72 bg-[#f5e6e6] rounded-full opacity-20"
          animate={{ y: [0, -20, 0], rotate: [0, 5, 0] }}
          transition={{ duration: 8, repeat: Infinity, ease: 'easeInOut' }}
        />
        <motion.div
          className="absolute bottom-40 left-10 w-48 h-48 bg-[#f0dcdc] rounded-full opacity-20"
          animate={{ y: [0, 15, 0], x: [0, 10, 0] }}
          transition={{ duration: 6, repeat: Infinity, ease: 'easeInOut', delay: 1 }}
        />
        <motion.div
          className="absolute top-1/2 right-20 w-32 h-32 bg-[#ebcfcf] rounded-full opacity-20"
      ...
      >
        ...
        <div className="flex flex-col md:flex-row items-center justify-between max-w-[85rem] mx-auto px-10 py-16 min-h-[85vh] gap-10">
          ...
          <div className="md:w-1/2 w-full">
            ...
            >
              ...
              {/* Stack paragraph + buttons with vertical gap */}
                ...
                <div className="mt-1 flex flex-col sm:flex-row gap-4 w-full sm:w-auto">
                  <Link href="https://app.scholarsoffinance.org/application/?universityId=652593b1-e24e-44a3-a896-29cf08961604" className="w-full sm:w-auto">
                    <motion.button
                      ...
                      whileTap={{ scale: 0.95 }}
                      className="box-border h-12 px-6 bg-gradient-to-r from-[#800000] to-[#500000] text-white font-semibold rounded-xl shadow-lg hover:shadow-xl transition-all duration-300 w-full sm:w-auto"
                    >
                      Apply to SOF
                    </motion.button>
                  </Link>
        ...
        <div className="bg-gray-50 py-16 relative">
          ...
          <div className="max-w-[85rem] mx-auto px-4 sm:px-6 lg:px-8 relative text-center">
            <Timeline
